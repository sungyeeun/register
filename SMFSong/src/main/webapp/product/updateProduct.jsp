...
<body>
    <div class="container">
        <h1 class="grid1">제품 수정 페이지</h1>
        
        <form id="formProduct" action="update" method="post">
            <label for="productCode">제품코드:</label>
            <input type="text" id="productCode" name="productCode" value="${product.productCode}" readonly> <!-- 수정X -->
            <label for="productName">제품명:</label>
            <input type="text" id="productName" name="productName" value="${product.productName}">
            <label for="productManager">관리자:</label>
            <input type="text" id="productManager" name="productManager" value="${product.productManager}">
            <br>
