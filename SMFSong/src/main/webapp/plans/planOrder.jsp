...
<body>
  ...
  <div class="btn-group">
    ...
    <ul class="dropdown-menu">
      <li><a class="dropdown-item" href="#" onclick="displaySelectedlength('S')">S</a></li>
      <li><a class="dropdown-item" href="#" onclick="displaySelectedlength('M')">M</a></li>
      <li><a class="dropdown-item" href="#" onclick="displaySelectedlength('L')">L</a></li>
      <li><a class="dropdown-item" href="#" onclick="displaySelectedlength('XL')">XL</a></li>
      <li><hr class="dropdown-divider"></li>
    </ul>
  </div>
